...
<a target="_blank" href="https://xyzscripts.com/members/product/purchase/XYZWPPOP"><img src="<?php  echo plugins_url("quick-bar/images/orange_buynow.png"); ?>"></a>
</div>
...
<div style="clear: both;"></div>
<div style="width: 100%">
<div class="xyz_qbr_social_media">
<h3 class="xyz_qbr_inner_head">Follow Us </h3>
...
<div class="xyz_qbr_sugession">
<h3 class="xyz_qbr_inner_head">Support</h3>
...
<p><a target="_blank" href="https://wordpress.org/support/plugin/quick-bar/reviews/">Please Rate Us
 </a></p>
<a target="_blank" href="https://wordpress.org/support/plugin/quick-bar/reviews/" ><span class="xyz_new_star"></span></a>
<p style="width:100%;"><a target="_blank" href="https://wordpress.org/support/plugin/quick-bar/" >Create a ticket at Wordpress forum</a></p>
</div>

<div class="xyz_qbr_new_subscribe">
<h3 class="xyz_qbr_inner_head">Stay tuned for our updates</h3>
...
<form action=https://xyzscripts.com/newsletter/index.php?page=list/subscribe method="post" name="email_subscription" id="email_subscription" >
...
<input class="xyz_qbr_name"  type="text" placeholder="Name" name="field1" value="<?php
...
?>"  >
<input class="xyz_qbr_email" name="email"
type="text" placeholder="email" style="" value="<?php    echo $current_user->user_email; ?>" />

<input id="xyz_qbr_submit_qbr" class="sbmt_btn" type="submit" value="subscribe" name="Submit"  onclick="javascript: if(!verify_fields()) return false; " />

<input type="hidden" name="listName" value="1,2,"/>
</form>
</div>

<div class="xyz_qbr_inmotion">
   <a target="_blank" href="http://inmotion-hosting.evyy.net/c/1150074/260033/4222">
   <img src="<?php echo plugins_url()?>/quick-bar/images/xyz.png" class="xyz_qbr_inmotion_label" /></a>
</div>
...
<div style="clear: both;"></div>
<div style="width: 100%">
<div class="xyz_qbr_our_plugins_new">
<p class="xyz_qbr_plugin_head">Our Plugins : </p>
