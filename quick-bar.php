<?php
/*
Plugin Name:Quick Bar - Popup Notification Bar
Plugin URI: http://xyzscripts.com/wordpress-plugins/quick-bar/
Description: This plugin allows you to create a popup notification sidebar with custom content in your site. You can customize the Quick Bar display by configuring various settings such as  position settings (height,width,top,left), display logic settings (time delay after page load, number of pages to browse,  repeat interval) and style settings(z-index, opacity, color, border etc). The plugin supports automatic and manual (shortcode) display.
Version: 1.2.2
...
function xyz_qbr_credit() {
	$content = '<div style="clear:both;width:100%;text-align:center; font-size:11px; "><a target="_blank" href="http://xyzscripts.com/wordpress-plugins/quick-bar/details"Popup Notification Bar</a> Powered By : <a target="_blank" title="PHP Scripts & Wordpress Plugins" href="http://www.xyzscripts.com" >XYZScripts.com</a></div>';
	echo $content;
}
